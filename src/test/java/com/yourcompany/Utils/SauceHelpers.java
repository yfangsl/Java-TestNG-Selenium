...
public class SauceHelpers {
    ...
    /**
     * Checks if TUNNEL_IDENTIFIER ENV var is set and sets it as needed.
     * If not set the capability is not set.
     * @param capabilities reference to desired caps.
     */
    public static void setSauceConnectTunnelId(DesiredCapabilities capabilities){
    ...
    /**
     * Checks if BUILD_TAG ENV var is set and sets it as needed.
     * If not set the capability is not set.
     * @param capabilities reference to desired caps.
     */
    public static void setSauceBuildName(DesiredCapabilities capabilities){
    ...
    /**
     * Sets all CI related capabilities if available.
     * @param capabilities
     */
    public static void setCICapabilities(DesiredCapabilities capabilities){
        setSauceBuildName(capabilities);
        setSauceConnectTunnelId(capabilities);
    }
}
